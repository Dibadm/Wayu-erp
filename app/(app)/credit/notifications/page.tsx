...
export default function OverdueNotificationsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">Overdue Notifications</h1>
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800/50">
              {notifications.map((n: any) => (
                <tr key={n.id} className="hover:bg-zinc-100 dark:hover:bg-white/[0.02]">
                  ...
                  <td className="px-4 py-2.5 stat-num text-sm text-amber-500 dark:text-amber-400">ETB {Number(n.amount).toLocaleString()}</td>
